...
public class SimolJava8Parser extends Parser {
	...
	public static final int
		...
		BYTE=5, ELSE=15, IF=22, ENUM=16, SUB=99, BANG=86, LPAREN=74, DOT=82, CASE=6, 
		AT=120, LINE_COMMENT=124, StringLiteral=72, ELLIPSIS=121, LBRACK=78, PUBLIC=35, 
		THROWS=45, NullLiteral=73, RSHIFT_ASSIGN=117, COMPAT_INTERF_VERSION=58, 
		...
		LONG_ACTION=62, DOUBLE=14, PROTECTED=34, LONG=29, COMMA=81, BITAND=102, 
		TOUR_MONITOR=65, PREVENT_MISSING_COLLISION=63, PRIVATE=33, CONTINUE=11, 
		DIV=101, NATURE=56, UNDERST=61, SIMU_REAL_WORLD_OBJ=52, FloatingPointLiteral=69, 
		LE=91, FOR_EVERY_THREAD=66, CharacterLiteral=71, VOLATILE=49, EXTENDS=17, 
		INSTANCEOF=26, NEW=31, ADD=98, LT=85, CLASS=9, DO=13, FINALLY=19, Identifier=119, 
		CONST=10, PACKAGE=32, OR_ASSIGN=113, TRY=47, REAL_WORLD_OBJ=54, IntegerLiteral=68, 
		SYNCHRONIZED=42, MUL=100, INFORMATION=55, FOR=21, FINAL=18, ONE_AT_A_TIME=64, 
		RPAREN=75, CARET=104, URSHIFT_ASSIGN=118, BOOLEAN=3, WITH_COMPAT=60, NOTEQUAL=93, 
		SIMU_COMP_WORKER=53, RBRACK=79, RBRACE=77, AND=94, THIS=43, SWITCH=41, 
		VOID=48, TRANSIENT=46, INC=96, FLOAT=20, NATIVE=30, DIV_ASSIGN=111, BooleanLiteral=70, 
		DEPENDENT_ACTIVITY=67, ABSTRACT=1, STRICTFP=39, INT=27, QUESTION=88, RETURN=36, 
		CLASS_FOR=51, LSHIFT_ASSIGN=116, ADD_ASSIGN=108, WS=122, GE=92, SUPER=40, 
		OR=95, DEC=97, MOD=105, XOR_ASSIGN=114, ASSERT=2, EQUAL=90, IMPLEMENTS=24, 
		COLON=89, GT=84, SHORT=37, COMPAT_INTERF_CAPACITY=59, MOD_ASSIGN=115, 
		WHILE=50, TILDE=87, DEFAULT=12;
	...
	public final CompilationUnitContext compilationUnit() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ABSTRACT) | (1L << ENUM) | (1L << FINAL) | (1L << PRIVATE) | (1L << PROTECTED) | (1L << PUBLIC) | (1L << STATIC) | (1L << STRICTFP) | (1L << CLASS_FOR) | (1L << SIMU_REAL_WORLD_OBJ) | (1L << SIMU_COMP_WORKER) | (1L << REAL_WORLD_OBJ) | (1L << INFORMATION) | (1L << COMPAT_INTERF_VERSION) | (1L << COMPAT_INTERF_CAPACITY))) != 0) || _la==SEMI || _la==AT) {
				{
				{
