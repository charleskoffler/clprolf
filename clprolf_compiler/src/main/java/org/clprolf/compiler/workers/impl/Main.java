 ...
 * (https://github.com/antlr/grammars-v4/tree/master/java/java8) 
 ...
 4.0.0 2025/10/15
 Implemented semantic checks, and tests: BB2, BB1, BA3, BA4
 
 Usage example: mvn exec:java -Dexec.mainClass="org.clprolf.compiler.Main" -Dexec.args="org/clprolf/compiler/semantic/tests/SemanticTests.clp"
